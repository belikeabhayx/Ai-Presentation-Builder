...
export const generateLayoutsJson = async (outlineArray: string[]) => {
  const prompt = 
//   `### Guidelines
//   IMPORTANT: Respond with only the raw JSON data. Do not include markdown formatting, explanations, or code blocks. The response should be valid JSON that can be directly parsed.
