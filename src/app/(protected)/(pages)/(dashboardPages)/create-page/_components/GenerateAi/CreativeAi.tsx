...
const CreateAI = ({ onBack }: Props) => {
  ...
  return (
    <motion.div
      ...
      animate="visible"
    >
      <Button onClick={handleBlack} variant="outline" className="mb-4">
      ...
      <motion.div className="bg-primary/10 rounded-xl" variants={itemVariants}>
        <div className="flex flex-col sm:flex-row justify-between gap-3 items-center rounded-xl">
          <Input
            value={currentAiPrompt || ""}
            onChange={(e) => setCurrentAiPrompt(e.target.value)}
            placeholder="Enter Prompt and add to the cards..."
            className="text-base sm:text-xl border-0 focus-visible:ring-0 shadow-none p-4 bg-transparent flex-grow"
            required
          />
          <div className="flex items-center gap-3">
            ...
            >
              <SelectTrigger className="w-fit gap-2 font-semibold shadow-xl">
                <SelectValue aria-placeholder="Select number of cards" />
              </SelectTrigger>
